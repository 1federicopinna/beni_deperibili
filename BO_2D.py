...
sa = SA(f_obj=f_obj, f_ngh=f_ngh, f_fid=f_fid, fidelity={1: 2 ** 2, 2: 2 ** 3, 3: 2 ** 4})
seeds = sa.sds[3]
...
def f(x):
    ...
    results = sa.simulate(S, s, i=4, seeds=seeds, n_days=n_days)
...
res = gp_minimize(
    ...
    dimensions=[(600, 800), (200, 350)],  # dominio di S e s
