...
disc_sl: Prob_mass_func = {13:0.1, 14:0.2 , 15:0.5, 16:0.2}  # shelf life discretizzata
...
# ideal vals vecchi -> {'i': 3.16, 'S': 660, 's': 114}, {'I': 5, 'S': 846, 's': 116}  
# valori teorici nuovi ->  {'S': 20230, 's': 10206, 'I': 4}) 
Pol = Policy(s = 10206, 
            S = 20230, 
            I = 4, 
            m_q = 50, # lotto minimo
